...
plt.figure()
ax = plt.subplot(111)
ax.plot(np.arange(startT, endT+1), conv_z2r(np.nanmean(np.nanmean(reinst_shift1_retr1, 1), 1)), color='#1f77b4')
ax.plot(np.arange(startT, endT+1), conv_z2r(np.nanmean(np.nanmean(reinst_shift1_retr0, 1), 1)), color='#1f77b4', linestyle='dashed')
ax.plot(np.arange(startT, endT+1), conv_z2r(np.nanmean(np.nanmean(reinst_shift0_retr1, 1), 1)), color='#ff7f0e')
ax.plot(np.arange(startT, endT+1), conv_z2r(np.nanmean(np.nanmean(reinst_shift0_retr0, 1), 1)), color='#ff7f0e', linestyle='dashed')
